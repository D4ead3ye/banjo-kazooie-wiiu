...
extern void anSeq_PushStep_1Arg(bk_vector(AnSeqElement) **, f32, void(*)(s32), s32);
extern void anSeq_PushStep_2Arg(bk_vector(AnSeqElement) **, f32, void(*)(s32,s32), s32, s32);
