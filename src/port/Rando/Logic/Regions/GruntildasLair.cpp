...
static RegisterShipInitFunc initFunc([]() {
    Regions[RR_GRUNTILDAS_LAIR_LOBBY] = RandoRegion{ .regionName = "Gruntilda's Lair Lobby", .levelId = LEVEL_6_LAIR,
        .checks = {
            ...
            CHECK(RC_GL_JIGGY_WITCH_SWITCH_FREEZEEZY_PEAK,      CAN_ACCESS(RA_WITCH_SWITCH_FREEZEEZY_PEAK)),
            CHECK(RC_GL_JIGGY_WITCH_SWITCH_GOBIS_VALLEY,        CAN_ACCESS(RA_WITCH_SWITCH_GOBIS_VALLEY)),
            CHECK(RC_GL_JIGGY_WITCH_SWITCH_MAD_MONSTER_MANSION, CAN_ACCESS(RA_WITCH_SWITCH_MAD_MONSTER_MANSION)),
            CHECK(RC_GL_JIGGY_WITCH_SWITCH_MUMBOS_MOUNTAIN,     CAN_ACCESS(RA_WITCH_SWITCH_MUMBOS_MOUNTAIN)),
            CHECK(RC_GL_JIGGY_WITCH_SWITCH_RUSTY_BUCKET_BAY,    CAN_ACCESS(RA_WITCH_SWITCH_RUSTY_BUCKET_BAY)),
            CHECK(RC_GL_JIGGY_WITCH_SWITCH_TREASURE_TROVE_COVE, CAN_ACCESS(RA_WITCH_SWITCH_TREASURE_TROVE_COVE)),
		},
        .connections = {
