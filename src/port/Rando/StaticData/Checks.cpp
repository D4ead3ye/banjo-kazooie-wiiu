...
std::map<RandoCheckId, RandoStaticCheck> Checks = {
    ...
    RC(RC_MM_MUMBO_TOKEN_BEHIND_PINK_JINJO,             RCTYPE_MUMBO_TOKEN, LEVEL_1_MUMBOS_MOUNTAIN,    ACTOR_2D_MUMBO_TOKEN,       5855, 0, 2169),
    RC(RC_MM_MUMBO_TOKEN_BEHIND_RUINS,                  RCTYPE_MUMBO_TOKEN, LEVEL_1_MUMBOS_MOUNTAIN,    ACTOR_2D_MUMBO_TOKEN,       -4869, 2255, -2506),
    RC(RC_MM_MUMBO_TOKEN_INSIDE_TICKERS_TOWER,          RCTYPE_MUMBO_TOKEN, LEVEL_1_MUMBOS_MOUNTAIN,    ACTOR_2D_MUMBO_TOKEN,       -343, 345, -518),
    RC(RC_MM_MUMBO_TOKEN_STUMP_NEAR_CONGA,              RCTYPE_MUMBO_TOKEN, LEVEL_1_MUMBOS_MOUNTAIN,    ACTOR_2D_MUMBO_TOKEN,       -4431, 475, 6183),
    RC(RC_MM_MUMBO_TOKEN_UNDER_RAMP_TO_MUMBOS_SKULL,    RCTYPE_MUMBO_TOKEN, LEVEL_1_MUMBOS_MOUNTAIN,    ACTOR_2D_MUMBO_TOKEN,       5150, 2168, -2447),
};
// clang-format on
