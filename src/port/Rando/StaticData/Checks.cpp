...
std::map<RandoCheckId, RandoStaticCheck> Checks = {
    ...
    RC(RC_TTC_JIGGY_BLUBBER,                            RCTYPE_JIGGY,           LEVEL_2_TREASURE_TROVE_COVE,    ACTOR_46_JIGGY,             JIGGY_14_TTC_BLUBBER,                           -389, 984, 852), //set location?
    RC(RC_TTC_JIGGY_JINJO,                              RCTYPE_JIGGY,           LEVEL_2_TREASURE_TROVE_COVE,    ACTOR_46_JIGGY,             JIGGY_0B_TTC_JINJO,                             -875, 292, 7206), //changes
    ...
    RC(RC_TTC_JIGGY_RED_X,                              RCTYPE_JIGGY,           LEVEL_2_TREASURE_TROVE_COVE,    ACTOR_46_JIGGY,             JIGGY_11_TTC_RED_X,                             7416, 716, 1484), //changes
