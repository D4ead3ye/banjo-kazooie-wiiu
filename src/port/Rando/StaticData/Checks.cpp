...
std::map<RandoCheckId, RandoStaticCheck> Checks = {
    ...
    RC(RC_MM_NOTE_SOUTH_SLOPE_FIRST_PLATFORM_1,         RITYPE_MUSIC_NOTE,      LEVEL_1_MUMBOS_MOUNTAIN,    ACTOR_51_MUSIC_NOTE,        NULL,                                           4867, 297, 1766),
    RC(RC_MM_NOTE_SOUTH_SLOPE_FIRST_PLATFORM_2,         RITYPE_MUSIC_NOTE,      LEVEL_1_MUMBOS_MOUNTAIN,    ACTOR_51_MUSIC_NOTE,        NULL,                                           4782, 298, 1892),
    RC(RC_MM_NOTE_SOUTH_SLOPE_FIRST_PLATFORM_3,         RITYPE_MUSIC_NOTE,      LEVEL_1_MUMBOS_MOUNTAIN,    ACTOR_51_MUSIC_NOTE,        NULL,                                           4971, 299, 1887),
};
// clang-format on
