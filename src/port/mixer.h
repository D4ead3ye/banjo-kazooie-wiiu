...
void aSetVolumeImpl(int8_t flags, float v, int, int);
...
void aEnvMixerImpl(uint16_t flags, void* addr);
...
#define aLoadBuffer(pkt, a) aLoadBufferImpl(a)
#define aSaveBuffer(pkt, d) aSaveBufferImpl(d)
...
#define aSetVolume(pkt, f, a, a3, a4) aSetVolumeImpl(f, a, a3, a4)
...
#define aEnvMixer(pkt, flags, addr) aEnvMixerImpl(flags, addr)
